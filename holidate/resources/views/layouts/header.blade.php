      ...
      <div class="topbar">
         ...
         <div class="topbar-left">
            <div class="text-center">
               <a href="{{ URL::to('dashboard') }}" class="logo"><i class="md md-terrain"></i> <span> ARK Blogs</span></a>
            </div>
         </div>
            ...
            <div class="container-fluid">
               ...
               <ul class="nav navbar-right float-right list-inline">
                  <li class="dropdown d-none d-sm-block">
                     ...
                     <i class="md md-notifications"></i> <span class="badge badge-pill badge-xs badge-danger"></span>
                     </a>
                     <ul class="dropdown-menu dropdown-menu-lg">
                        <li class="text-center notifi-title">Notification</li>
                        <li class="list-group">
                                                      <!-- list item-->
                           <a href="{{ URL('notification-data')}}" class="list-group-item">
                              <div class="media">
                                 <div class="media-left pr-2">
                                    <em class="fa fa-birthday-cake text-primary"></em>
                                 </div>
                                 <div class="media-body clearfix">
                                    <div class="media-heading">Anniversary</div>
                                    <p class="m-0">
                                       <small>Today's 
                                       <span class="text-primary"></span> Persones Anniversary</small>
                                    </p>
                                 </div>
                              </div>
                           </a>
                           ...
                           <a href="{{ URL('notification-data')}}" class="list-group-item">
                              <div class="media">
                                 <div class="media-left pr-2">
                                    <em class="fa fa-birthday-cake text-danger"></em>
                                 </div>
                                 <div class="media-body clearfix">
                                    <div class="media-heading">Birthday</div>
                                    <p class="m-0">
                                       <small>Today's
                                       <span class="text-primary"></span> Persons Birthday</small>
                                    </p>
                                 </div>
                              </div>
                           </a>
