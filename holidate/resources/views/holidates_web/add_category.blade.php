...
<section class="allforms">
    <div class="login_form">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 profile_description">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form class="register_form register_form1 show_label" id="categoryForm" action="{{ URL::to('addcategory') }}"
            ...
            <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">-->
            <!--    <form class="register_form"  action="{{ URL::to('addcategory') }}" method="POST" id="FormValidation" enctype="multipart/form-data">-->
            <!--   {{csrf_field()}}-->
