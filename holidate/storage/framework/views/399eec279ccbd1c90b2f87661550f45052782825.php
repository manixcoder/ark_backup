                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        ...
                                                        <select name="professional_category_id" class="form-control">
                                                            <option disabled value="<?php echo e($user->professional_category->id ?? ''); ?>"><?php echo e($user->professional_category->name ?? 'Select Your Professional Category'); ?></option>
...
<?php /**PATH D:\Web\htdocs\222holidates_new\resources\views/holidates_web/profile_edit.blade.php ENDPATH**/ ?>