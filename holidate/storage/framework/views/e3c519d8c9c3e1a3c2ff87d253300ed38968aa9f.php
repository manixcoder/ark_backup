    ...
    <div class="container">
        <div class="row">
            <ul style="display: flex;">
                <div style="">
                    <a href="/all_people" class="linkme" <?php if(Request::url() === 'http://holidate.es' or Request::path() == 'all_people'): ?> style="color: #FDCE22;
                    background-color: #000000;
                    border: 1px solid #000000;
                    font-size: 14px;
                    padding: 7px 20px;
...
<?php /**PATH D:\xampp\htdocs\222holidate\resources\views/holidates_web/inc/header_search.blade.php ENDPATH**/ ?>