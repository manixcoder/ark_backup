                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header left-nav">
                            ...
                            <a class="navbar-brand logo" href="<?php echo e(URL::to('home')); ?>">
                                <img src="<?php echo e(asset('web_assets/images/logo.png')); ?>" class="img-responsive" />
                            </a>
                        </div>
...
<div class="scoreBoxAlert <?php if(Request::path() == 'user_profile/edit'): ?> hidden <?php endif; ?>">
    <strong><?php echo e(__('Hi')); ?> <?php echo e(Auth::User()->name); ?>!! </strong> <?php echo e(__('You have to full-fill your profile to show yourself in another user search results')); ?>!!
    <a href="<?php echo e(route('user.profile.edit')); ?>"><?php echo e(__('Go to edit section')); ?></a>
</div>
<?php else: ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\222holidate\resources\views/web_layout/header.blade.php ENDPATH**/ ?>