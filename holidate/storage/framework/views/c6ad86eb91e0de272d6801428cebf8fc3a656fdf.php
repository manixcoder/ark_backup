...
<div class="container">
    <div class="row" style="margin:40px 0 80px 0; min-height:60vh;">
        ...
        <?php else: ?>
            ...
            <div class="hidden"><?php echo e($myNearUsers = DB::table('users')->pluck('name')); ?></div>
            <?php else: ?>
            <?php if(!Auth::User()->latitude): ?>
            <?php else: ?>    
            <div class="hidden"><?php echo e($myNearUsers = Auth::User()->getNearBy(Auth::User()->latitude,Auth::User()->longitude, 50 )->pluck('id')); ?></div>
            <?php endif; ?>
            <?php endif; ?>
            <div style="margin: 20px 0;">Results are shown near 50 kms of you!</div>
            <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($result->user->score == 100): ?>
                
                <?php if(isset($myNearUsers, $result->user->id)): ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 width400">
                    <div class="row nomargin">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 people_content nopadding"><div class="people_img">
                                <img src="<?php echo e(asset('profile_image/')); ?>/<?php echo e($result->user->profile_image); ?>"/>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 people_info">
                                <h4><?php echo e($result->user->name); ?> <?php echo e($result->user->surname); ?></h4>
                                <?php if($result->user->hobbies->count() == 0): ?>
                                <?php else: ?>
                                
                                <h5><?php echo e($result->user->hobbies->first()->name); ?></h5>
                                <?php endif; ?>
                                <p>
                                    <?php if(!$result->user->city): ?>
                                    <?php else: ?>
                                    <?php echo e($result->user->city); ?>
                                ...
                                <a href="<?php echo e(route('connect', $result->user->id)); ?>" class="btn btn-block people_btn" onclick="return confirm('First you have to pay for see details');" class="people_conection">Connect</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    scroll();
</script><?php /**PATH D:\Web\htdocs\222holidates_new\resources\views/holidates_web/search_data.blade.php ENDPATH**/ ?>