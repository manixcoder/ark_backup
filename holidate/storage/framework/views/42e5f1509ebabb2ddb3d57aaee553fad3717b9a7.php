        ...
        <div class="navigation-section">
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand logo" href="index.html"><img src="<?php echo e(asset('web_assets/images/logo.png')); ?>" class="img-responsive"/></a>
                    </div>
                                    ...
                                    <form class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offet-0 col-xs-offset-0">
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-4 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 col-xs-offset-1 nopadding">
                                                <p class="location_img"><img src="<?php echo e(asset('web_assets/images/location1.png')); ?>"/></p>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 width100">
                                <div class="row nomargin">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 event_content">
                                        ...
                                        <p class="location"><img src="<?php echo e(asset('web_assets/images/place.png')); ?>"/><b>Location Name</b></p>
                                        <div class="row">
                                            <div class="col-lg-8 col-md-8 col-sm-7 col-xs-8 people_count">
                                                <p><img src="<?php echo e(asset('web_assets/images/user.png')); ?>"/> <b>10 people attending</b></p>
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 group_content">
                                        <div class="row">
                                            <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                                <img src="<?php echo e(asset('web_assets/images/group1.png')); ?>"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 people_count">
                                                <p><img src="<?php echo e(asset('web_assets/images/user1.png')); ?>"/> <b>100</b></p>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 width400">
                                <div class="row nomargin">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 group_content">
                                        <div class="row">
                                            <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                                <img src="<?php echo e(asset('web_assets/images/group2.png')); ?>"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 width400">
                                <div class="row nomargin">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 group_content">
                                        <div class="row">
                                            <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                                <img src="<?php echo e(asset('web_assets/images/group3.png')); ?>"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 width400">
                                <div class="row nomargin">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 group_content">
                                        <div class="row">
                                            <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                                <img src="<?php echo e(asset('web_assets/images/group4.png')); ?>"/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                                ...
                                <div class="row nomargin">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 people_content nopadding">
                                        <div class="people_img">
                                            <img src="<?php echo e(asset('web_assets/images/people1.png')); ?>"/>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 width400">
                                <div class="row nomargin">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 people_content nopadding">
                                        <div class="people_img">
                                            <img src="<?php echo e(asset('web_assets/images/people2.png')); ?>"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 people_info">
                                            <h4>John Doe</h4>
                                            <h5>Guitarist</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category1.png')); ?>" width="100%"/>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category2.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Nightlife</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category3.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Food & Drink</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category4.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Sports & Fitness</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category5.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Music</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category6.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Movements</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category7.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Film</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category8.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Video Games</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category9.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>LGBTQ</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category10.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Arts</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category11.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Social</p>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 category_section width400">
                                <div class="row nomargin">
                                    <a href="categories/categories.html">
                                        <div class="img_section col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <img src="<?php echo e(asset('web_assets/images/category12.png')); ?>" width="100%"/>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                            <p>Career & Business</p>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 app_right_content width100">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <ul>
                                            <li><a href="#"><img src="<?php echo e(asset('web_assets/images/app_store.png')); ?>"/></a></li>
                                            <li><a href="#"><img src="<?php echo e(asset('web_assets/images/google_play.png')); ?>"/></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<script src="<?php echo e(asset('web_assets/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('web_assets/js/functionality.js')); ?>"></script><?php /**PATH D:\Web\htdocs\222holidates_new\resources\views/home.blade.php ENDPATH**/ ?>