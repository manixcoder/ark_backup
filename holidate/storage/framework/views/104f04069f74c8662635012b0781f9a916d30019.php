            ...
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12">
                        <form action="<?php echo e(route('adminpanel.user.search')); ?>" method="GET" role="search" class="app-search hidden-sm hidden-xs m-r-10">
                            <?php echo csrf_field(); ?>
                            <span class="xo_grp">
                                <span class="xo_grp_label"><?php echo e(__('from')); ?></span>
                                <input type="date" name="from" id="" class="xo_input date__1" placeholder="from">
                            </span>
                            <span class="xo_grp">
                                <span class="xo_grp_label"><?php echo e(__('to')); ?></span>
                                <input type="date" name="to" id="" class="xo_input date__1" placeholder="to">
                            </span>
                            <span>
                                <input type="text" name="search" placeholder="<?php echo e(__('Search')); ?>..." class="search_input xo_input"> 
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div class="row" style="padding-bottom:20px;">
                                                <div class="col-md-12">
                                                    <form action="<?php echo e(route('adminpanel.user.updatepassword')); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="text" name="user_id" value="<?php echo e($user->id); ?>" style="display: none;">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holidate/holidate_web/resources/views/admin/users.blade.php ENDPATH**/ ?>