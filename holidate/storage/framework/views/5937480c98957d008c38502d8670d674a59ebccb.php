...
<div class="container">
    <div class="row" style="margin:40px 0 80px 0; min-height:60vh;">
        ...
        <div class="h2"><?php echo e(__('Results for')); ?> <?php echo e($search); ?>

            <?php if($cat == '0'): ?>
            <?php else: ?>
                <?php echo e(__('in')); ?> <?php echo e($cat->category_name); ?> <?php echo e(__('Category')); ?>

            <?php endif; ?>
        </div>
        <?php if($users->count() == 0): ?>
            <p style="margin: 10px 0;"><?php echo e(__('Sorry!! No Results found for')); ?> <?php echo e($search); ?></p>
        <?php else: ?>            
            <div style="margin: 20px 0;"><?php echo e(__('Results are shown near 50 kms of you')); ?>!</div>
...
<script>
    ...
    scroll();
</script><?php /**PATH D:\Web\htdocs\222holidates_new\resources\views/holidates_web/search_result.blade.php ENDPATH**/ ?>